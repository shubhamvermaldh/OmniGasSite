<section class="hero-section" style="background: linear-gradient(135deg, rgba(30, 64, 175, 0.50) 0%, rgba(59, 130, 246, 0.95) 100%), url('assets/images/lpg_gas_plant_indust_a5fd5858.jpg') center/cover no-repeat;">
    <div class="container">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Leading provider of LPG Plant Design, Installation, Commissioning, Equipment Supply, Autogas Systems, and LPG Distribution</p>
            <div class="hero-buttons">
                <a href="index.php?page=about" class="btn btn-primary">Learn More</a>
                <a href="index.php?page=contact" class="btn btn-secondary">Get In Touch</a>
            </div>
        </div>
    </div>
</section>
